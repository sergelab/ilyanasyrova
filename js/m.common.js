jQuery(function($) {
    $(document).ready(function() {
        if (!(device.ipad() || device.androidTablet() || device.ipod() || device.mobile() || device.iphone() || device.android() || device.fxosPhone() || device.fxosTablet() || device.fxos() || device.blackberryTablet())) {
